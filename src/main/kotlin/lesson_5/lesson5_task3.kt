...
const val LOST_MESSAGE = "Правильные числа были 42 и 21 соответственно"
...
fun main() {
    ...
    when {
        userFibonacciNumber == FIBONACCI_SEQUENCE_NUMBER && userDouglasNumber == DOUGLAS_ADAMS_NUMBER -> println("Поздравляем, вы выиграли главный приз")
        userFibonacciNumber == FIBONACCI_SEQUENCE_NUMBER || userDouglasNumber == DOUGLAS_ADAMS_NUMBER -> println("Вы выиграли утешительный приз. $LOST_MESSAGE")
